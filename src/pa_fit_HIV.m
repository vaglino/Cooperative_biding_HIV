...
% Stefano Travaglino - 2020/06/25

% Script fits adhesion frequency data for "Cooperative Binding of HIV-1 
% Envelope Glycoprotein to CD4 and Coreceptor" paper, and in general, 
% provides examples on how to use model fitting library
...
%% CD4-HIV-X4 trimoleclular bond fit (2-path, 2-step)

type=2; %2 for 2 step 2 path model
...
n1_mean = Pa2n(Pa1_mean);
n2_mean = Pa2n(Pa2_mean);
n3_mean = Pa2n(Pa3_mean);
n1 = sum(n_fit_1,1);
n2 = sum(n_fit_2,1);
n3 = sum(n_fit_3,1);
...
type = 2;
[normalized_rates, fluxes] = flux_analysis(type,k_fit_3,indep_vars,...
...
% normalize n bimolecular by trimolecular dens and stds
n1_norm = n1./densities_1(1).*densities_3(1); 
n2_norm = n2./densities_2(2).*densities_3(2);
n1_std_norm = n1_std./densities_1(1).*densities_3(1);
n2_std_norm = n2_std./densities_2(2).*densities_3(2);
figure % cooperativity index calculation
% [coop_indx, sd_coop_indx] = cooperativity_index(t,n1_norm',n2_norm',n3',...
%                                             n1_std,n2_std,n3_std);
%                                         
[coop_indx, sd_coop_indx] = cooperativity_index(t,n1_norm',n2_norm',n3',...
                                            n1_std_norm,n2_std_norm,n3_std);                                                                        
...
%% helper functions to convert <n> to Pa and vice versa
function [Pa] = n2Pa(n) 
Pa = 1 - exp(-n);
end
